...
namespace ECC
{
    public partial class ECC : Form
    {
        ...
        private void encrypt_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Encrypted successfully. Next, please choose a file to save the encrypted key");

            SaveFileDialog sfd = new SaveFileDialog();
            sfd.ShowDialog();
            if (sfd.FileName == String.Empty)
            {
                MessageBox.Show("Please choose a file to save the encrypted key. Thanks!");
                return;
            }
        ...
        private void decrypt_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Please choose a file to decrypt. Thanks!");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (sfd.FileName == String.Empty)
            {
                MessageBox.Show("Please choose a file to save your key pair. Thanks!");
                return;
            }
